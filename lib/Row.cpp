...
memoria::Row::Row(std::vector<RowValue> data) { this->data_ = std::move(data); }
...
memoria::RowValue &memoria::Row::at(std::size_t i) { return data_.at(i); }

std::size_t memoria::Row::size() const noexcept { return data_.size(); }
