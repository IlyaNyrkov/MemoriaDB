...
public:
  ...
  [[nodiscard]] std::vector<Statement>
...
private:
  ...
  splitOutsideQuotes(std::string_view script);
  ...
  ieqPrefix(std::string_view s,
            std::string_view kw); // case-sensitive keywords if you want: set to
                                  // strict eq if needed
};
